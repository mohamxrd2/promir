...
<div id="displaying_erea" class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex justify-center items-center mb-2 mt-2">
            <h1 class="flex justify-center items-center text-black text-5xl">Liste des ventes</h1>
        </div> 
    ...
    <div id="adding_erea" class="hidden group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex justify-center items-center mb-2 mt-2">
            <h1 class="flex justify-center items-center text-black text-5xl">Ajouter une vente</h1>
        </div> 
                                ...
                                <form id="formulaire_ajout">
                                    ...
                                    <div class="flex mb-2">
                                        <div class="col mr-2 w-full">
                                            ...
                                            <option value="" disabled selected>Choisissez le type de vente</option>
                                    ...
                                    <div id="produit_template0" class="produit-item mb-8">
                                        <div class="flex mb-2">
                                            <div class="col mr-2 w-full">
                                                <label for="element_a_vendre">Produit</label>
                                                ...
                                                <option value="-1" disabled selected>Choisissir un produit...</option>
                                        ...
                                        <div class="flex mb-2">
                                            <div class="div_quantite_envoyee col mr-2 w-full">
                                                ...
                                                <input type="number" name="quantite_envoyee[0]" class="quantite_envoyee ltr:pl-8 rtl:pr-8 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 mr-2 w-full" placeholder="Tapez ici..." autocomplete="on">
                                            </div>
                                            <div class="col mr-2 w-full">
                                                <label for="quantite_vendue">Quantité vendue</label>
                                                <input type="number" step="any" name="quantite_vendue[0]" class="quantite_vendue ltr:pl-8 rtl:pr-8 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 w-full" placeholder="Tapez ici..." autocomplete="on">
                                            </div>   
                                            <div class="col mr-2 w-full">
                                                <label for="prix_vente">Prix min vente</label>
                                                <input readonly type="number" name="prix_vente[0]"  class="prix_vente ltr:pl-8 rtl:pr-8 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 mr-2 w-full" placeholder="Tapez ici..." autocomplete="on">
                                            </div>
                                            
                                            <div class="col mr-2 w-full">
                                                <label for="prix_reel_vente">Prix réel vente</label>
                                                <input type="number" name="prix_reel_vente[0]"  class="prix_reel_vente ltr:pl-8 rtl:pr-8 form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200 mr-2 w-full" placeholder="Tapez ici..." autocomplete="on">
                                            </div>
                                        </div>
                                        <div class="flex mb-2">
                                            <div class="col mr-2 w-full">
    ...
    <div id="modifying_erea" class="hidden group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        <div class="flex justify-center items-center mb-2 mt-2">
                <h1 class="flex justify-center items-center text-black text-5xl">Modifier une vente</h1>
            </div> 
                <div class="transition-opacity duration-500">
                    <div class="col-span-12 card 2xl:col-span-12 ">
                        <div class="card-body">
    ...
    <script>
        ...
        function addInputEventToSpecificInput(element){
            ...
            const typeVente = $('#type_de_vente_add').val();


            const quantite_vendue = $(element + ' .quantite_vendue');
            const prix_reel_vente = $(element + ' .prix_reel_vente');
            
            $( element + ' .montant_regle').css('border', "1px solid rgba(0, 0, 0, 0.1)");
            $( element + ' .montant_regle').on('input', function(){

                if($('#type_de_vente_add').val() == "Au comptant"){
                    if($(this).val() < (quantite_vendue.val() * prix_reel_vente.val())){
                        $(this).css("border", "1px solid rgba(255, 0, 0, 0.5)");
                    }else if($(this).val() == (quantite_vendue.val() * prix_reel_vente.val())){
                        $(this).css("border", "1px solid rgba(0, 255, 0, 0.5)");
                    }else if($(this).val() > (quantite_vendue.val() * prix_reel_vente.val())){
                        $(this).css("border", "1px solid rgba(128, 0, 128, 0.5)");
                    }
                }else{
                    $(this).css("border", "1px solid rgba(0, 0, 255, 0.1)");
                }
            });


                $(element_a_vendre_selecte).on('change', function() {
                    const ligneClient = $('#ligne_client_systeme_selecte').val();
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            ligneClient: ligneClient ? ligneClient[0] : null
                        },
                        success: function(response) {
                            if (response.produitTransforme) {
                                $(element + ' .element_a_vendre_input').val(response.produitTransforme.designation);
                                $(element + ' .prix_vente').val(response.produitTransforme.prix_unitaire_portion);
                                $(element + ' .prix_reel_vente').val(response.produitTransforme.prix_unitaire_portion);
                                $(element + ' .quantite_envoyee').val(response.totalQuantiteLivree);
                            } else {
                ...
                $(element + ' .element_a_vendre_input').on('input', function () {
                    clearTimeout(timeId);
                ...
                $.ajax({
                    url: "{{route('render_produits_avec_type_vente_pt')}}",
                    method: 'GET',
                    data: { 
                        typeVente: typeVente,
                        client: document.getElementById('ligne_client_systeme_selecte').value,
                    ...
                    success: function (response) {
                        if(response.produits){
                            ...
                            $.each(response.produits, function(index, produit){
                                element_a_vendre_selecte.append(
                                    $('<option></option>').attr('value', produit.id).text(produit.designation + ' (' + produit.reference + ')' + ' (' + produit.prix_unitaire_portion + ' FCFA)' + ' (' + produit.portion_unitaire + ')')
                                );
                            });
                            return;
                        }else if(response.other_error){
        ...
        $(document).ready(function () {
            ...
            $('#ajouter_produit').on('click', function () {
                ...
                newProduit.attr('id', 'produit_template' + String(produitCounter));
                ...
                // handleQuantiteVendueInput(produitCounter, newProduit);
                newProduit.removeClass('hidden');
                $('#produit_container').append(newProduit);
                addInputEventToSpecificInput('#'+newProduit.attr('id'));
        ...
        function ajouter(){
            ...
            // handleQuantiteVendueInput(0, produitTemplateInitial)
            updateClients();
            clients_on_change("{{route('render_produits_avec_type_vente_pt')}}");
        }
    ...
    function details_vente(){
        ...
        $.ajax({
            url: "{{route('render-details-vente_pt')}}",
            method: 'GET',
            data: { query: venteId },
            success: function(response) {
                var lignesVentes = response.lignesVentes;
                ...
                $.each(lignesVentes, function(index, lignesVente) {
                    ...
                    var invendue = lignesVente.quantite_envoyee - lignesVente.quantite_vendue;
                    var valeur_vendue = lignesVente.prix_vente * lignesVente.quantite_vendue;
                    var valeur_invendue = lignesVente.prix_vente * invendue;
                    var totale_valeur = lignesVente.prix_vente * lignesVente.quantite_envoyee;
                    var reste_a_regler = valeur_vendue - lignesVente.montant_regle;
                    ...
                    var row = '<tr data-id="' + lignesVente.id + '">' +
                        ...
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500"><a href="#">' + lignesVente.produit_transforme.reference + '</a></td>' +
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">' + lignesVente.produit_transforme.designation + '</td>' +
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">' + lignesVente.prix_vente + '</td>' +
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">' + lignesVente.quantite_envoyee + '</td>' +
                        ...
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">' + invendue + '</td>' +
                        '<td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">' + valeur_invendue + '</td>' +
        ...
        formulaire_ajou.addEventListener('submit', function(event) {
            ...
            if(document.getElementById('ligne_client_systeme_selecte').value === ""){
                return toastr.info('Veuillez choisir un client dans la liste...');
            }
            if ($('#type_de_vente_add').val() === "Au comptant") {
                if(verificationReglements(true).trueFalse === true && verificationReglements(true).numeroProduit !== null){
                    return toastr.warning('Le montant du produit ' + verificationReglements(true).numeroProduit + ' est incorrecte! Veuillez entrer une valeur cerrecte...');
                }
            }
            ...
            $('.prix_vente').each(function() {
               ...
               request.open('POST', '/store_vente_pt');
               ...
               request.onreadystatechange = function() {
                if (request.readyState === XMLHttpRequest.DONE) {
                    if (request.status === 200) {
                        ...
                        if(response.quatiteLivreeInsuffisante){
                            var errorMessageElements = document.querySelectorAll('.error-message');
                            if(errorMessageElements.length > 0){
                                errorMessageElements.forEach(function(element) {
                                    element.parentNode.removeChild(element);
                            ...
                            toastr.warning('Le produit ' + response.quatiteLivreeInsuffisante + ' est en defaut de dépôt vente.');
                            return;
                        }
        ...
        selectRenderClientsForVentes('render_clients_avec_type_vente_pt');
    </script>  
