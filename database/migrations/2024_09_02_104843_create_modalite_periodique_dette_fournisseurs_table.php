...
return new class extends Migration
{
    ...
    {
        Schema::create('modalite_periodique_dette_fournisseurs', function (Blueprint $table) {
            $table->id();
            $table->foreignId('dette_fournisseur_id')->nullable();
            $table->foreign('dette_fournisseur_id', 'mpdf_df_id_foreign')
                ->references('id')
    ...
    {
        Schema::dropIfExists('modalite_periodique_dette_fournisseurs');
    }
};
